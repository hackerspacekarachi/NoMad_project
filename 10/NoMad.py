...
"")
        ...
        binary_o = QtWidgets.QToolButton(self.options_2)
        binary_o.setText("Keystroke 1")
        binary_o.setStyleSheet('''
                    ...
                    ''')
        binary_o.setGeometry(QtCore.QRect(50, 10, 221, 21))
        binary_o.setPopupMode(QtWidgets.QToolButton.InstantPopup)
        menu_o.triggered.connect(lambda x: self.menu_triggered(binary_o, x.text()))
...
"")
        ...
        binary_2o.setStyleSheet('''
                    ...
                    ''')
        binary_2o.setGeometry(QtCore.QRect(50, 10, 221, 21))
