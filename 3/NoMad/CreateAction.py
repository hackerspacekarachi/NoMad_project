...
"}")
    ...
    def retranslateUi(self, CreateAction):
        ...
        CreateAction.setGeometry(QtCore.QRect((ax*0.106)+678, wae*0.065, 400, 623))
        ...
        self.pushButton.setText(_translate("CreateAction", "Logo1"))
        self.pushButton_2.setText(_translate("CreateAction", "Logo1"))
