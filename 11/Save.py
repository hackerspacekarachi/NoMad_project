...
class Ui_Save(object):
    ...
    def save_profile(self):
        if self.lineEdit_93.text() in os.listdir('./'):
...
"}")
        ...
        self.pushButton_92 = QtWidgets.QPushButton(self.frame_9)
...
"}")
        ...
        self.pushButton_92.clicked.connect(lambda: subprocess.run(['python', 'NoMad.py']))
