...
import ctypes, string, shutil, subprocess
...
class Ui_NoMad(object):
    global a, b, la, la_x, count_prof, ks #Using 'a' for Vector popup, 'b' for save toggle
    a, b, la, la_x, count_prof, ks = 0, 0, 4, 630, 0, 300
    ...
    def keystrokes(self):
        ...
        self.options_4 = QtWidgets.QFrame(self.create_area)
        self.options_4.setGeometry(QtCore.QRect(30, ks, 301, 41))
        ...
        self.binary_3o.setText("Click to assign")
        self.binary_3o.setStyleSheet('''
                    ...
                    text-align: left;
                    ''')
        self.binary_3o.setGeometry(QtCore.QRect(40, 8, 250, 25))
        self.binary_3o.setPopupMode(QtWidgets.QToolButton.InstantPopup)
        menu_3o.triggered.connect(lambda y: self.menu_triggered(self.binary_o, y.text(),1))

        self.binary_o.setMenu(menu_3o)
        self.add_menu(K1, menu_3o)

        self.toolButton_3o = QtWidgets.QToolButton(self.options_4)
        self.toolButton_3o.setGeometry(QtCore.QRect(5, 5, 31, 31))
        self.toolButton_3o.setText("")
        pixmap = QtGui.QPixmap("Icons/menu.png")
        icon = QtGui.QIcon(pixmap)
        self.toolButton_3o.setIcon(icon)
        self.toolButton_3o.setObjectName("toolButton_3o")

        ks+= 50

        self.lineEdit_4o = QtWidgets.QLineEdit(self.create_area)
        self.lineEdit_4o.setGeometry(QtCore.QRect(150, ks, 81, 20))
        font = QtGui.QFont()
        ...
        self.lineEdit_4o.setPlaceholderText("+ add delay")
        self.lineEdit_4o.setObjectName("lineEdit_4o")

        
        ks+=30
        self.add_ks.setGeometry(QtCore.QRect(30, ks, 301, 41))

        ks+= 80
        self.label_2o.setGeometry(QtCore.QRect(140, ks, 111, 16))

        ks+=20
        self.lineEdit_5o.setGeometry(QtCore.QRect(30, ks, 301, 30))

        ks+=40
        self.pushButton_2o.setGeometry(QtCore.QRect(90, ks, 191, 31))
    ...
    def create_new(self):
        ...
        self.options_2 = QtWidgets.QFrame(self.create_area)
        self.options_2.setGeometry(QtCore.QRect(30, 140, 301, 41))
        ...
        self.binary_o.setText("Click to assign")
        self.binary_o.setStyleSheet('''
                    ...
                    border-radius: 12px;
                    ''')
        self.binary_o.setGeometry(QtCore.QRect(40, 8, 250, 25))
        ...
        self.toolButton_o.setGeometry(QtCore.QRect(5, 5, 31, 31))
        self.toolButton_o.setText("")
        pixmap = QtGui.QPixmap("Icons/menu.png")
        icon = QtGui.QIcon(pixmap)
        self.toolButton_o.setIcon(icon)
        self.toolButton_o.setObjectName("toolButton_o")

        self.lineEdit_2o = QtWidgets.QLineEdit(self.create_area)
        self.lineEdit_2o.setGeometry(QtCore.QRect(150, 190, 81, 20))
        font = QtGui.QFont()
        font.setFamily("Work Sans Light")
        ...
        self.lineEdit_2o.setPlaceholderText("+ add delay")
        self.lineEdit_2o.setObjectName("lineEdit_2o")

        
        # 2nd Keystroke
        self.options_3 = QtWidgets.QFrame(self.create_area)
        self.options_3.setGeometry(QtCore.QRect(30, 220, 301, 41))
        ...
        self.binary_2o.setText("Click to assign")
        self.binary_2o.setStyleSheet('''
                    ...
                    ''')
        self.binary_2o.setGeometry(QtCore.QRect(40, 8, 250, 25))
        ...
        self.toolButton_2o.setGeometry(QtCore.QRect(5, 5, 31, 31))
        self.toolButton_2o.setText("")
        pixmap = QtGui.QPixmap("Icons/menu.png")
        icon = QtGui.QIcon(pixmap)
        self.toolButton_2o.setIcon(icon)
        self.toolButton_2o.setObjectName("toolButton_2o")
        
        self.lineEdit_3o = QtWidgets.QLineEdit(self.create_area)
        self.lineEdit_3o.setGeometry(QtCore.QRect(150, 270, 81, 20))
        font = QtGui.QFont()
        font.setFamily("Work Sans Light")
        ...
        self.lineEdit_3o.setPlaceholderText("+ add delay")
        self.lineEdit_3o.setObjectName("lineEdit_3o")

        # add new keystroke
        self.add_ks = QtWidgets.QPushButton(self.create_area, clicked = lambda: self.keystrokes())
        self.add_ks.setGeometry(QtCore.QRect(30, 300, 301, 41))
        ...
        self.label_2o = QtWidgets.QLabel(self.create_area)
        self.label_2o.setGeometry(QtCore.QRect(140, 380, 111, 16))
        ...
        self.lineEdit_5o = QtWidgets.QLineEdit(self.create_area)
        self.lineEdit_5o.setGeometry(QtCore.QRect(30, 400, 301, 30))
        font = QtGui.QFont()
        font.setFamily("Work Sans Light")
        self.lineEdit_5o.setFont(font)
        self.lineEdit_5o.setStyleSheet("    border: 1px solid black;\n"
        "    border-radius: 15px;\n"
        "    padding-left:10px;\n"
        "    background-color: rgb(242, 242, 242);\n"
        "    border-color: #f2f2f2;\n"
        "")
        self.lineEdit_5o.setPlaceholderText("Name the category...")
        self.lineEdit_5o.setObjectName("lineEdit_5o")

        self.pushButton_2o = QtWidgets.QPushButton(self.create_area)
        self.pushButton_2o.setGeometry(QtCore.QRect(90, 440, 191, 31))
    ...
    def basic_keys(self):
        ...
        self.h1.setGeometry(QtCore.QRect(22, 0, 70, 20))
        self.h1.setStyleSheet("font: 8pt \"Work Sans Medium\";")
        ...
        self.h2.setStyleSheet("font: 8pt \"Work Sans Medium\";")
        ...
        self.h3.setGeometry(QtCore.QRect(22, h1+h2, 80, 20))
        self.h3.setStyleSheet("font: 8pt \"Work Sans Medium\";")
        ...
        self.h4.setGeometry(QtCore.QRect(22, h1+h2+h3, 80, 20))
        self.h4.setStyleSheet("font: 8pt \"Work Sans Medium\";")
        ...
        self.h5.setStyleSheet("font: 8pt \"Work Sans Medium\";")
        self.h5.setText("Special")
        self.h5.setObjectName("h5")
        h5 = 30  # area in lenght of heading 4

        special = ['-','!','@','#','$','%','^','&&','*','(',')','_','+','{','}','|',':','\"','<','>','?','NUHS','NUBS','Ro','¥','無变换','漢字','한영','变换','かな','Esc`','LS (','RS )',
        ...
        self.h6.setStyleSheet("font: 8pt \"Work Sans Medium\";")
        ...
        self.h7.setStyleSheet("font: 8pt \"Work Sans Medium\";")
    ...
    def layer_1(self):
        for specific_element in self.frame_2.children():
            if specific_element in list(self.previous_text.keys()):
                specific_element.setText(self.previous_text[specific_element])
    
    def layer_2(self):
        for element in self.frame_2.children():
            element.setText("")

        self.pushButton_3.setText("F1")
        self.pushButton_5.setText("F2")
        self.pushButton_4.setText("F3")
        self.pushButton_8.setText("F4")
        self.pushButton_6.setText("F5")
        self.pushButton_7.setText("F6")
        self.pushButton_67.setText("F7")
        self.pushButton_11.setText("F8")
        self.pushButton_10.setText("F9")
        self.pushButton_12.setText("F10")
        self.pushButton_50.setText("F11")
        self.pushButton_48.setText("F12")
...
#         self.lineEdit_4o.setObjectName("lineEdit_4o")
        ...
        self.addKeystrokeButton_o = QtWidgets.QPushButton(self.options_6)
...
"}")
        ...
        self.Keystroke_area.setGeometry(QtCore.QRect(0, 140, 370, 400))
...
"}")
        ...
        self.commandLinkButton = HoverCommandLinkButton("Community", "Icons/www.png", self.frame_4)
...
"border-radius: 12px;")
        ...
        self.pushButton_86 = QtWidgets.QPushButton(self.frame_81, clicked = lambda: self.layer_1())
...
"}")
        ...
        self.pushButton_87 = QtWidgets.QPushButton(self.frame_81, clicked = lambda: self.layer_2())
...
"}")
        ...
        self.pushButton_88 = QtWidgets.QPushButton(self.frame_81, clicked = lambda: self.layer_3())
...
"}")
        ...
        self.pushButton_89 = QtWidgets.QPushButton(self.frame_81, clicked = lambda: self.layer_3())
        ...
        if current_size != self.last_size:
            if  self.CreateAction.frameGeometry().width() != 0:
                ...
                if self.options.frameGeometry().width() != 0:
                        ...
                        self.profiles_area.setGeometry(QtCore.QRect(0, 190, 370, NoMad.frameGeometry().height()-300))
                        self.Keystroke_area.setGeometry(QtCore.QRect(0, 140, 370, NoMad.frameGeometry().height()-250))
