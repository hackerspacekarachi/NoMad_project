...
import os, sys, json, time, serial
...
class Ui_NoMad(object):
    ...
    def openCreateAction(self):
        ...
        NoMad.setGeometry(0, 30, 1079, 623)
    ...
    def layer(self,num):
        ...
        # fire_base.put('INPUT/','layers', push_data)
        ref = db.reference("INPUT/")
        loaded_dict["profile"] = data
        loaded_dict = self.hid(loaded_dict)
        self.esp32(loaded_dict)

        # # Firebase
        # from firebase import firebase
        # fire_base2 = firebase.FirebaseApplication('https://input2-e17c6-default-rtdb.firebaseio.com/', None)
        # fire_base2.put('INPUT2/','layer', data)
        # del firebase, fire_base2
    ...
    def esp32(self, lyr):
        ...
        for i in range(5):
                ...
                for key, value in lyr["layer1"].items():
                        if key == "244" and value == 0:
                                write_ser(f'"{key}": {value}')
                                break
                        else:
                                write_ser(f'"{key}": {value}') 
...
"border: none;")
        ...
        # self.scrollArea_keyboard.horizontalScrollBar().setMinimum(0)
        # self.scrollArea_keyboard.horizontalScrollBar().setMaximum(99)
        # self.scrollArea_keyboard.horizontalScrollBar().setSliderPosition(50)
        ...
        # self.abc = QtWidgets.QScrollBar(self.frame)
        # self.abc.setOrientation(QtCore.Qt.Horizontal)
        # self.abc.setSliderPosition(50)
        # self.abc.setStyleSheet("background-color: red;")
...
"}")
        ...
        # for element in self.last_frame.children():
        #      if isinstance(element, QtWidgets.QScrollBar):
