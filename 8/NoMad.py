...
#         self.buttonGroup.addButton(self.pushButton_2)
        ...
        self.frame_3.setMinimumSize(QtCore.QSize(1151, 27))
        self.frame_3.setMaximumSize(QtCore.QSize(16777215, 27))
...
# "border-radius: 25px;")
        ...
        self.frame_4.setGeometry(QtCore.QRect(0, 0, 1151, 40))  # 0, 27
        self.frame_4.setMinimumSize(QtCore.QSize(1151, 40))
...
"color: rgb(255, 255, 255);\n")
        ...
        self.frame_6.setGeometry(QtCore.QRect(0, 75, 1151, 75))
        self.frame_6.setMinimumSize(QtCore.QSize(1151, 75))
...
"border-radius: 25px;")
        ...
        print("w,h:"+str(NoMad.frameGeometry().width())+","+ str(NoMad.frameGeometry().height()))
        self.frame_5.setGeometry(QtCore.QRect(15, 140, 0, 0))
...
# "border-radius: 25px;")
        ...
        # verticalSpacer = QtWidgets.QSpacerItem(100, 150,  QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        # self.boxLayout.addItem(verticalSpacer)
...
"}")
        ...
        self.pushButton_79.setGeometry(QtCore.QRect(350, 0, 111, 41))
...
"")
        ...
        self.pushButton_80.setGeometry(QtCore.QRect(480, 0, 111, 41))
...
"}")
        ...
        self.pushButton_83.setGeometry(QtCore.QRect(580, 0, 111, 41))
...
"")
        ...
        self.Lay_f3 = QtWidgets.QHBoxLayout(self.frame)
        self.Lay_f3.setObjectName("Lay_f3")

        self.pushButton_68 = QtWidgets.QPushButton(self.frame_3)
        self.pushButton_68.setGeometry(QtCore.QRect(55, 6, 13, 13))
...
# "}")
        ...
        self.pushButton_69.setGeometry(QtCore.QRect(15, 6, 13, 13))
        print(NoMad.frameGeometry().width())
        print(NoMad.x())
...
"}")
        ...
        self.pushButton_97.setGeometry(QtCore.QRect(35, 6, 13, 13))
        self.pushButton_97.setMinimumSize(QtCore.QSize(0, 0))
        self.pushButton_97.setMaximumSize(QtCore.QSize(88, 32))
...
"}")
        ...
        self.commandLinkButton.setGeometry(QtCore.QRect(1050, 0, 111, 41))
        # font = QtGui.QFont()
...
"")
        ...
        self.commandLinkButton_5.setGeometry(QtCore.QRect(880, 25, 200, 41))
...
"")
        ...
        self.commandLinkButton_6 = QtWidgets.QCommandLinkButton(self.frame_6, clicked = lambda: self.Vect_art())
        self.commandLinkButton_6.setGeometry(QtCore.QRect(5, 30, 200, 41))
        print(self.commandLinkButton_6.x())
...
"")
        icon = QtGui.QIcon()
        pic = self.resource_path("my_profile.png")
        icon.addPixmap(QtGui.QPixmap(pic), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.commandLinkButton_7.setIcon(icon)
        self.commandLinkButton_7.setObjectName("commandLinkButton_7")

        self.pushButton_90 = QtWidgets.QPushButton(self.frame_6, clicked = lambda: self.Vect_art())
        self.pushButton_90.setGeometry(QtCore.QRect(100, 40, 17, 17))
        icon = QtGui.QIcon()
...
"border-radius: none;")
        ...
        self.pushButton_91 = QtWidgets.QPushButton(self.frame_6)
        self.pushButton_91.setGeometry(QtCore.QRect(1030, 38, 17, 17))
        icon = QtGui.QIcon()
        pic = self.resource_path("next.png")
        icon.addPixmap(QtGui.QPixmap(pic), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-radius: none;")
        ...
        self.pushButton_85 = QtWidgets.QPushButton(self.frame_6)
        self.pushButton_85.setGeometry(QtCore.QRect(330, 35, 25, 25))
...
"border-radius: 12px;")
        ...
        self.pushButton_84 = QtWidgets.QPushButton(self.frame_6)
        self.pushButton_84.setGeometry(QtCore.QRect(365, 35, 130, 25))
...
"border-radius: 12px;")
        ...
        self.pushButton_86.setGeometry(QtCore.QRect(510, 35, 25, 25))
...
"border-radius: 12px;")
        ...
        self.pushButton_87 = QtWidgets.QPushButton(self.frame_6)
        self.pushButton_87.setGeometry(QtCore.QRect(550, 35, 25, 25))
...
"border-radius: 12px;")
        ...
        self.pushButton_88 = QtWidgets.QPushButton(self.frame_6)
        self.pushButton_88.setGeometry(QtCore.QRect(590, 35, 25, 25))
...
"border-radius: 12px;")
        ...
        self.pushButton_89 = QtWidgets.QPushButton(self.frame_6)
        self.pushButton_89.setGeometry(QtCore.QRect(630, 35, 25, 25))
