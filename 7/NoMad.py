...
# "border-radius: 25px;")
        ...
        self.boxLayout.addWidget(self.frame_7,1,QtCore.Qt.AlignCenter) #,0,QtCore.Qt.AlignCenter
...
"}")
        ...
        self.commandLinkButton.setGeometry(QtCore.QRect(950, 0, 111, 41))
        # font = QtGui.QFont()
...
"")
        ...
        self.pushButton_90 = QtWidgets.QPushButton(self.frame_6)
