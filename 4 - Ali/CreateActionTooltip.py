...
class Ui_CreateAction(object):
    ...
    def action(self, var, place, num):
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(var['image_path']), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon5)
        self.pushButton.setIconSize(QtCore.QSize(35, 35))
        self.pushButton.setObjectName("pushButton")

    def show_tooltip(self, json_file):
        with open(json_file) as f:
            data = json.load(f)
        action = data['settings']['action']
        QToolTip.showText(QtGui.QCursor.pos(), action)    

        self.pushButton.setToolTip(data['settings']['action'])
        self.show_tooltip(json_file)
    ...
    def setupUi(self, CreateAction):
        ...
        for file_name in os.listdir('Profiles/'):
            if file_name.endswith(".json"):
                ...
                with open('Profiles/'+file_name) as p:
...
"")
    ...
    def retranslateUi(self, CreateAction):
        ...
        CreateAction.setGeometry(QtCore.QRect(int(ax*0.106)+678, int(wae*0.065), 400, 623))
