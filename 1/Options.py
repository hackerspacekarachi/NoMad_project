...
"}")
    ...
    def retranslateUi(self, Options):
        ...
        Options.setWindowTitle(_translate("Options", "SecondWindow"))
        Options.setGeometry(QtCore.QRect((ax*0.106)+678, wae*0.065, 400, 623))
        ...
        self.comboBox_2.setItemText(3, _translate("Options", "23"))
        self.comboBox_2.setItemText(4, _translate("Options", "24"))
        ...
        self.comboBox_3.setItemText(4, _translate("Options", "34"))
