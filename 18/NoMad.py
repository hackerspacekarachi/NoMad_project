...
import ctypes, string, shutil, random, configparser
...
#         self.addKeystrokeButton_o.setVisible(False)
    ...
    def layer_1(self):
        for specific_element in self.frame_2.children():
             ...
             val = str(val)
             if val in list(self.previous_text_L1.keys()):
                  specific_element.setText(self.previous_text_L1[val])
                #   print(specific_element.x(),  specific_element.y())
    ...
    def layer_2(self):
        ...
        if os.path.isfile(self.resource_path('layer2.json')):
             with open(self.resource_path('layer2.json'), 'r') as js_file:
        ...
        with open(self.resource_path('layer2.json'), 'w') as js_file:
             json.dump(self.previous_text_L2, js_file)
    ...
    def layer_3(self):
        ...
        if os.path.isfile(self.resource_path('layer3.json')):
             with open(self.resource_path('layer3.json'), 'r') as js_file:
                  loaded_dict = json.load(js_file)
    ...
    def binary_search_replace(self, key, new_value, num):
        filename = f'layer{num}.json'

        if not os.path.exists(filename):
             with open(self.resource_path(filename), 'w') as file:
                  file.write('{}')
...
" \n7"))
        ...
        with open(self.resource_path('layer1.json'), 'w') as js_file:
             json.dump(self.previous_text_L1, js_file)
        self.layer_1()
